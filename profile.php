    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>الملف الشخصي</b></h2>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">الرئيسية</a></li>
            ...
            <div class="container">
                ...
                <div class="dashboard-personal-info p-5 bg-white">
                    <form action="#" method="post">
                        <h5 class="text-secondary border-bottom-on-white pb-3 mb-4">تواصل مع الادمن</h5>
						<?php echo $msg; ?><?php echo $error; ?>
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <label for="user-id">اسم المستخدم</label>
                                ...
                                <div class="form-group">
                                    <label for="about-me">نص رسالتك</label>
                            ...
                            <div class="col-lg-5 col-md-12">
                                ...
                                <div class="user-info mt-md-50"> <img src="admin/user/<?php echo $row['6'];?>" alt="userimage">
                                    ...
                                    <div class="font-18">
                                        ...
                                        <div class="mb-1"><b>الايميل:</b> <?php echo $row['2'];?></div>
                                        <div class="mb-1"><b>رقم التواصل:</b> <?php echo $row['3'];?></div>
										<div class="mb-1 text-capitalize"><b>العضوية:</b> <?php echo $row['5'];?></div>
										<div class="mb-1 text-capitalize"><b>الرفع المسموح:</b> <?php echo $row['7'];?><b> عقار فقط</b></div>
                                    </div>
									<?php } ?>
                                </div>
                            </div>
