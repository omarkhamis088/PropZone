    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">إرسال العقار</h2>
                        </div>
					</div>
                    <div class="row p-5 bg-white">
                        <form method="post" enctype="multipart/form-data">
								<div class="description">
									<h5 class="text-secondary">معلومات اساسية</h5><hr>
									<?php echo $error; ?>
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="title" required placeholder="ادخل عنوان">
													</div>
												</div> 
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">محتوى</label>
													<div class="col-lg-9">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="ptype">
															...
															<option value="flat">بدروم</option>
										...
										<h5 class="text-secondary">السعر والموقع</h5><hr>
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="floor">
															...
															<option value="5th Floor">الدور الخانس</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="totalfl">
															<option value="">حدد عدد الادوار</option>
															<option value="1 Floor">دور</option>
															<option value="2 Floor">دورين</option>
															<option value="3 Floor">3 دور</option>
															<option value="4 Floor">4 دور</option>
															<option value="5 Floor">5 دور</option>
															<option value="6 Floor">6 دور</option>
															<option value="7 Floor">7 دور</option>
															<option value="8 Floor">8 دور</option>
															<option value="9 Floor">9 دور</option>
															<option value="10 Floor">10 دور</option>
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">المساحة</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="asize" required placeholder="حدد المساحة بالقدم">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">العنوان</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="loc" required placeholder="ادخل العنوان">
													</div>
												</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
											<p class="alert alert-danger">* هام يرجى عدم إزالة المحتوى أدناه فقط قم بتغيير <b>نعم</b> أو <b>لا</b> أو التفاصيل ولا تقم بإضافة المزيد من التفاصيل</p>
