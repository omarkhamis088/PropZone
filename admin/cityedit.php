...
if(isset($_POST['insert']))
{
	...
	if(!empty($ustate) && !empty($ucity))
	{
		...
		if($result)
			{
				$msg="<p class='alert alert-success'>تم تعديل المديرية بنجاح</p>";
				header("Location:cityadd.php?msg=$msg");
			}
			else
			{
				$msg="<p class='alert alert-warning'>لم يتم تعديل المديرية</p>";
				header("Location:cityadd.php?msg=$msg");
			}
	}
	else{
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h1 class="card-title">تعديل مديرية</h1>
									<?php echo $error;?>
									<?php echo $msg;?>
									<?php 
										if(isset($_GET['msg']))	
								...
								<form method="post">
									<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													<h5 class="card-title">تفاصيل المديرية</h5>
