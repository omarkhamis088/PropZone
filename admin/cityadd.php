            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">المديرية</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">لوحة التحكم</a></li>
									<li class="breadcrumb-item active">المديرية</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h1 class="card-title">اضافة مديرية</h1>
									<?php echo $error;?>
									<?php echo $msg;?>
									<?php 
										if(isset($_GET['msg']))	
								...
								<form method="post" id="insert product" enctype="multipart/form-data">
									<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													<h5 class="card-title">معلومات المديرية</h5>
													<div class="form-group row">
														<label class="col-lg-3 col-form-label">اسم المحافظة</label>
														<div class="col-lg-9" >	
													...
													<div class="form-group row">
														<label class="col-lg-3 col-form-label">اسم المديرية</label>
														<div class="col-lg-9">
											...
											<div class="text-left">
												<input type="submit" class="btn btn-primary"  value="ارسال" name="insert" style="margin-left:200px;">
											</div>
									</div>
								</form>
							</div>
				...
				<div class="row">
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">قائمة المديريات</h4>
									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											?>
                                                <tr>
													...
													<td><a href="cityedit.php?id=<?php echo $row['0']; ?>"><button class="btn btn-info">تعديل</button></a>
                                                   <a href="citydelete.php?id=<?php echo $row['0']; ?>"><button class="btn btn-danger">حذف</button></a></td>
                                                </tr>
                                                <?php $cnt=$cnt+1; } ?>
