            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">المحافظة</h3>
								<ul class="breadcrumb">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h1 class="card-title">اضافة محافظة</h1>
									<?php echo $error;?>
									<?php echo $msg;?>
									<?php 
										if(isset($_GET['msg']))	
								...
								<form method="post" id="insert product" enctype="multipart/form-data">
									<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													<h5 class="card-title">معلومات المحافظة</h5>
											...
											<div class="text-left">
												<input type="submit" class="btn btn-primary"  value="اضافة" name="insert" style="margin-left:200px;">
											</div>
									</div>
								</form>
							</div>
									...
									<table id="basic-datatable " class="table table-bordered table-hover">
											...
											?>
                                                <tr>
													...
													<td><a href="stateedit.php?id=<?php echo $row['0']; ?>"><button class="btn btn-info">تعديل</button></a>
                                                    <a href="statedelete.php?id=<?php echo $row['0']; ?>"><button class="btn btn-danger">حذف</button></a></td>
                                                </tr>
                                                <?php $cnt=$cnt+1; } ?>
