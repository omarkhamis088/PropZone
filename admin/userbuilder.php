						...
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">البناء</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">قائمة البنائون</h4>
									<?php 
										if(isset($_GET['msg']))	
										echo $_GET['msg'];	
									?>
									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											?>
                                                <tr>
                                                    ...
                                                    <td><a href="userbuilderdelete.php?id=<?php echo $row['0']; ?>"><button class="btn btn-danger">حذف</button></a></td>
                                                </tr>
                                                <?php
												$cnt=$cnt+1;
												} 
