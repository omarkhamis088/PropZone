            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<h2 class="text-secondary double-down-line text-center mb-5">تواصل معنا</h2>
								...
								<form class="w-100" action="#" method="post">
									<div class="row">
										<div class="row mb-4">
											...
											<div class="form-group col-lg-6">
												<input type="text"  name="phone" class="form-control" placeholder="الهاتف" maxlength="10">
											</div>
											<div class="form-group col-lg-6">
											...
											<div class="col-lg-12">
												<div class="form-group">
													<textarea name="message" class="form-control" rows="5" placeholder="اكتب رسالتك..."></textarea>
												</div>
											</div>
										</div>
										<button type="submit" value="send message" name="send" class="btn btn-success">ارسل الرسالة</button>
									</div>
								</form>
							</div>
						</div>
