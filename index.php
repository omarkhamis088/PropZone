    ...
    <div class="row"> 
                            ...
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="city" placeholder="ادخل المديرية" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-success w-100">البحث عن العقارات</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">العقارات الحديثة</h2>
                    </div>
                    <!--- <div class="col-md-6">
                                    ...
                                    <div class="col-md-6 col-lg-4"> 
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                <div class="featured bg-success text-white">جديد</div>
                                                <div class="sale bg-success text-white text-capitalize">لل <?php echo $row['5'];?></div>
                                                <div class="price text-primary"><b>$<?php echo $row['13'];?> </b><span class="text-white"><?php echo $row['12'];?> قدمًا</span></div>
                                            </div>
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    <ul>
                                                        <li><span><?php echo $row['12'];?></span> قدمًا</li>
                                                        <li><span><?php echo $row['6'];?></span> غرف نوم</li>
                                                        <li><span><?php echo $row['7'];?></span> حمامات</li>
                                                        <li><span><?php echo $row['9'];?></span> مطبخ</li>
                                                        <li><span><?php echo $row['8'];?></span> شرفة</li>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <div class="living-list pr-4">
                            <h3 class="pb-4 mb-3 text-white">لماذا تختارنا؟</h3>
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-reward flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">خبرة محلية عميقة</h5>
										<p>فريقنا يتمتع بفهم شامل لسوق العقارات في المنطقة، مما يساعدك على اتخاذ قرارات مستنيرة سواء كنت تشتري، تبيع، أو تستثمر.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">تجربة مميزة وسهلة</h5>
										<p>نقدم خدمات متكاملة تجعل رحلتك العقارية سهلة وسلسة، من التصفح وحتى إتمام المعاملات، مع دعم متواصل.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">شبكة علاقات واسعة</h5>
										<p>نعمل مع مجموعة كبيرة من العملاء والمستثمرين، مما يمنحك فرصًا أكبر للوصول إلى أفضل العروض في السوق.</p>
									</div>
                                </li>
                            </ul>
                        </div>
		...
		<!--	How it work -->
        <div class="full-row" >
            <div class="container"class="direction: ltr;">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">عقار متاح</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">عقار للبيع متاح</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">عقار للإيجار متاح</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-man flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">مستخدمين مسجلين</div>
                            </div>
                        </div>
        ...
        <!--	Popular Place -->
        <div class="full-row bg-gray Popular-Places">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">الأماكن الشعبية</h2></div>
                </div> 
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/it4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    ...
                                    <span><?php 
												$total = $row[0];
												echo $total;?> عقارات مدرجة</span> </div>
									<?php } ?>
                            </div>
                        </div> 
                        <div class="col-md-6 col-lg-3 pb-1">
        ...
        <!--	Footer   start-->
            <div class="footer" class="width: 100%;
            text-align: right;
            direction: ltr;
            color:red;">
